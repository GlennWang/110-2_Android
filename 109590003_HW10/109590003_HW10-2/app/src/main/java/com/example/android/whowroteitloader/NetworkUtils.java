...
public class NetworkUtils {
     ...
     */
    static String getSource(Context context,String queryString, String protocol) {

        // Set up variables for the try block that need to be closed in the
        // finally block.
        String[] pChoose = context.getResources().getStringArray(R.array.protocol_choose);
